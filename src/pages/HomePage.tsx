    ...
    <main ref={root} className="overflow-x-hidden w-full max-w-full bg-[#fdfdfb] text-[#0a0a0a] font-grotesk">
      ...
      <nav className="fixed inset-x-0 top-4 z-50 flex justify-center px-4">
        <div className="flex w-full max-w-3xl items-center justify-between gap-4 rounded-full border border-white/40 bg-white/70 px-3 py-2 pl-5 shadow-lg shadow-black/5 backdrop-blur-xl">
          ...
          <div className="flex items-center gap-2">
            <Link to="/login" className="hidden rounded-full px-4 py-2 text-sm font-medium text-black/70 transition-colors hover:text-black sm:block">
              Entrar
            </Link>
            <Link to="/cadastro" className="rounded-full bg-[#0a0a0a] px-4 py-2 text-sm font-semibold text-white transition-transform hover:scale-105">
              Criar conta
            </Link>
          </div>
        </div>
      ...
      <section className="relative grain mesh-dark flex min-h-screen flex-col items-center justify-center overflow-hidden px-6 text-center">
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          <div data-hero className="mt-10 flex flex-wrap items-center justify-center gap-3">
            <Link to="/cadastro" className="group inline-flex items-center gap-2 rounded-full bg-white px-7 py-3.5 text-base font-semibold text-[#0a0a0a] transition-transform hover:scale-105">
              Criar minha página
              <ArrowUpRight className="size-5 transition-transform group-hover:translate-x-0.5 group-hover:-translate-y-0.5" />
            </Link>
            <Link to="/login" className="inline-flex items-center rounded-full border border-white/30 px-7 py-3.5 text-base font-semibold text-white transition-colors hover:bg-white/10">
              Já tenho conta
            </Link>
          </div>
        </div>
      ...
      <section className="grain mesh-dark relative overflow-hidden px-6 py-32 text-center md:py-48">
        <div className="relative z-10 mx-auto max-w-4xl">
          ...
          <Link to="/cadastro" className="mt-10 inline-flex items-center gap-2 rounded-full bg-white px-9 py-4 text-lg font-semibold text-[#0a0a0a] transition-transform hover:scale-105">
            Começar agora
      ...
      <footer className="border-t border-black/10 bg-[#fdfdfb] px-6 py-12">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 sm:flex-row">
          ...
          <div className="flex gap-6 text-sm text-black/60">
            <Link to="/login" className="hover:text-black">Entrar</Link>
            <Link to="/cadastro" className="hover:text-black">Criar conta</Link>
          </div>
        </div>
      </footer>
    </main>
