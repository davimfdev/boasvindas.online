    ...
    <main ref={root} className="overflow-x-hidden w-full max-w-full bg-[#fdfdfb] text-[#0a0a0a] font-grotesk">
      ...
      <section id="recursos" className="mx-auto max-w-6xl px-6 pb-32 md:pb-48">
        ...
        <div className="grid auto-rows-[minmax(170px,auto)] grid-flow-dense grid-cols-2 gap-3 md:grid-cols-6">
          ...
          <article data-bento className="group col-span-1 row-span-2 overflow-hidden rounded-3xl bg-[#0d9488] p-7 text-white md:col-span-2">
          ...
          <article data-bento className="group col-span-1 overflow-hidden rounded-3xl border border-black/10 bg-white p-7 md:col-span-2">
            ...
            <h3 className="font-display mt-3 text-lg font-bold leading-tight">Check-in guiado</h3>
          </article>

          <article data-bento className="group col-span-2 overflow-hidden rounded-3xl bg-[#fbbf24] p-7 text-[#0a0a0a] md:col-span-2">
            <MapPin className="size-7" />
            <h3 className="font-display mt-3 text-lg font-bold leading-tight">Guia local com mapa e Waze</h3>
          </article>
        </div>
      </section>
